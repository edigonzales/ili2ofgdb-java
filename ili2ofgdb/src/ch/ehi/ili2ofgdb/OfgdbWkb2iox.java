...
public class OfgdbWkb2iox
{
  ...
  throws IOException, ParseException
  {
    ...
    int simpleType = typeInt & 0xFFFF;
    int baseType = simpleType % 1000;
    int isoDimEncoding = simpleType - baseType;
    boolean hasEwkbZ = (typeInt & WKBConstants.ewkbIncludesZ) == WKBConstants.ewkbIncludesZ;
    boolean hasEwkbM = (typeInt & WKBConstants.ewkbIncludesM) == WKBConstants.ewkbIncludesM;
    ...
    boolean hasZ = hasEwkbZ || hasIsoZ;
    boolean hasM = hasEwkbM || hasIsoM;
